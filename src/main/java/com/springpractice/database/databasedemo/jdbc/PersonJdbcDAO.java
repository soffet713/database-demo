package com.springpractice.database.databasedemo.jdbc;
...
public class PersonJdbcDAO {
    ...
    public List<Person> findByLocation(String loc) {
        return jdbcTemplate.query("select * from person where location=?", new Object[]{loc},
                new PersonRowMapper());
    }

    public List<Person> findByName(String n) {
        return jdbcTemplate.query("select * from person where name=?", new Object[]{n},
                new PersonRowMapper());
    }
